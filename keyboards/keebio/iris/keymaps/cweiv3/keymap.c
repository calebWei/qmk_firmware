...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        ...
        [2] = LAYOUT(KC_NO, BL_ON, BL_OFF, BL_UP, BL_DOWN, BL_TOGG, RGB_TOG, RGB_MOD, RGB_RMOD, RGB_VAI, RGB_VAD, KC_NO, KC_NO, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_NO, KC_LSFT, KC_P1, KC_P2, KC_P3, KC_P4, KC_P5, KC_P6, KC_P7, KC_P8, KC_P9, KC_P0, KC_RSFT, KC_LCTL, KC_VOLD, KC_VOLU, KC_PAUS, KC_NUM, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_F11, KC_F12, KC_RCTL, KC_TRNS, KC_TRNS, KC_LALT, KC_RALT, KC_TRNS, KC_TRNS),
